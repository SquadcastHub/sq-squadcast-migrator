...
from src.terraform.models import SquadcastUser, SquadcastTeam
from src.schemas.migration import UserMigrationStats, TeamMigrationStats

logger = logging.getLogger(__name__)


class OpsgenieTerraformer:
    """
    ...
    def __init__(self, output_dir: Path = None, provider_config: Dict[str, str] = None):
        ...
        self.config_manager = TerraformExporter(self.output_dir, self.provider_config)
    ...
    def export_terraform_config(self):
        ...
        return self.config_manager.export()
