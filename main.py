...
from src.opsgenie.migrator import OpsgenieTerraformer
...
def main():
    ...
    try:
        ...
        if export_result["status"] == "success":
            ...
            logger.info("✅ Created variables.tf file for sensitive data")
            ...
            logger.info("✅ Created terraform.tfvars.example file as a template")
